...
namespace PemesananTiket
{
    public partial class Report : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT MONTH(Pemesanan.tanggal_pesan) AS 'Bulan', Pemesanan.total_bayar AS 'Income' FROM Pemesanan WHERE tanggal_pesan >= @from AND tanggal_pesan <= @to", conn);
            ...
            {
                Month = new DateTime(DateTime.Now.Year, d.Field<int>("Bulan"), 1).ToString("MMMM"),
